...
// src/constants.ts
var PLUGIN_DISPLAY_NAME = "Mission Board";
var COLUMN_UNASSIGNED = "\uBBF8\uBD84\uB958";
var UNIQUE_WORK_LABELS = ["[\uACE0\uC720\uC5C5\uBB34]", "\uACE0\uC720\uC5C5\uBB34"];
...
var IN_PROGRESS_STATUSES = /* @__PURE__ */ new Set(["in_progress", "in_review"]);
var MS_PER_DAY = 24 * 60 * 60 * 1e3;
var STALE_AFTER_DAYS = 5;
var UNIQUE_WORK_LABEL_SET = new Set(UNIQUE_WORK_LABELS);
...
function startOfWeekKst(now = /* @__PURE__ */ new Date()) {
...
function resolveInheritedLabels(issueId, issueById, memo, seen) {
  ...
  const currentSeen = seen ?? /* @__PURE__ */ new Set();
...
function createIssueCard(issue, effectiveLabels, weekStart, now = /* @__PURE__ */ new Date()) {
  const createdAt = parseDate(issue.createdAt);
...
function buildWorkBoardSnapshot(issues, options) {
  ...
  for (const [missionId, members] of missionMembers.entries()) {
    ...
    let taskIssues = hasChildren ? members.filter((member) => member.id !== missionId) : members;
