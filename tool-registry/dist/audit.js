...
export function analyzeRunLog(log) {
...
async function resolveInspectorAgentId(ctx, companyId) {
...
export async function createAuditIssue(ctx, companyId, agentName, violations) {
